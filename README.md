...
| `agentic-docs` | Per impostare/audire/correggere i file di contesto per agenti AI (`AGENTS.md`/`CLAUDE.md`, varianti annidate): pattern symlink, scoping per area/progetto/account, contenuti, verifica drift, e come evitare che contesto di un altro account/dominio finisca caricato dove non serve. |
